...
// Returns instruction text only — the actual source documents are attached
// as separate Gemini content parts (inline PDF/image data, or extracted
// docx text) alongside this in the request, not embedded here as a string.
...
// Used by the "quick question" mode — same idea, instructions only, with
// the attached document(s) providing the actual material to answer from.
